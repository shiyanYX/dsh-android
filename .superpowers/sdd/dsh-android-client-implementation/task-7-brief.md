...
## Objective
Create WebSocket client for real-time communication with DSH server.

## Files to Create
- `app/src/main/java/com/dsh/android/data/remote/DshWebSocketClient.kt`

## Requirements

### 1. DshWebSocketClient.kt
```kotlin
...
- Uses domain models from Task 2: `Message`, `ToolCall`, `WebSocketEvent`, `AgentStatus`, `MessageRole`
...
- Verify message parsing for assistant/message, tool/call, agent/status
- Verify sendMessage and confirmToolCall methods
